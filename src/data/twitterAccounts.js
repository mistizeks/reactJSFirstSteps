...
export const twitterAccounts = [
    ...
    },
    {
        ...
        name: 'Kent C. Dodds',
        description: 'Making software development more accessible Â· Husband, Father, Latter-day Saint, Teacher, OSS, GDE, @TC39 Â· @PayPalEng @eggheadio @FrontendMasters Â· #JS',
